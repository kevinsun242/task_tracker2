defmodule TaskTracker.TimeblocksTest do
  ...
  describe "time" do
    ...
    test "list_timeblocks/0 returns all time" do
    ...
    test "create_timeblock/1 with valid data creates a timeblock" do
      ...
      assert timeblock.end == ~T[14:00:00]
      assert timeblock.start == ~T[14:00:00]
    end
    ...
    test "update_timeblock/2 with valid data updates the timeblock" do
      ...
      assert timeblock.end == ~T[15:01:01]
      assert timeblock.start == ~T[15:01:01]
    end
